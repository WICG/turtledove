...
Since reserved.top\_navigation beacons are automatically generated by the browser, there needs to be some way for those beacons to be associated with and append event data, as it happens in reportEvent generated beacons. For this purpose, a new API would be added which can be invoked from within the fenced frame:
