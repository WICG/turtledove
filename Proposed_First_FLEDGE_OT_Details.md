...
*   "language-exclusions"
*   "category-exclusions"
The default value will be "not-available", in cases when a bid was not rejected, or it was rejected but the seller doesn't provide one reject reason.
